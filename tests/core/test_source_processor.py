...
class TestSourceProcessor:
  ...
  def test_parse_file_jar_uri(
    self, source_processor: SourceProcessor, sample_jar_file: Path
  ) -> None:
  ...
  def test_parse_file_directory_uri(
    self, source_processor: SourceProcessor, sample_directory: Path
  ) -> None:
  ...
  def test_parse_unsupported_file_type(
    self, source_processor: SourceProcessor, temp_dir: Path
  ) -> None:
  ...
  @patch("src.core.source_processor.requests.head")
  def test_validate_http_uri_not_accessible(
    self, mock_head: Mock, source_processor: SourceProcessor
  ) -> None:
  ...
  def test_process_file_jar_source(
    self, source_processor: SourceProcessor, sample_jar_file: Path
  ) -> None:
  ...
  def test_process_file_directory_source(
    self, source_processor: SourceProcessor, sample_directory: Path
  ) -> None:
  ...
  def test_process_http_source(
    self, mock_get: Mock, source_processor: SourceProcessor
  ) -> None:
    ...
    with patch("builtins.open", mock_open()):
      result = source_processor.process_source(
        "com.example", "library", "1.0.0", "https://example.com/library-sources.jar"
      )
  ...
  @patch("src.core.source_processor.requests.get")
  def test_process_http_source_download_failure(
    self, mock_get: Mock, source_processor: SourceProcessor
  ) -> None:
  ...
  def test_process_git_ssh_source(self, source_processor: SourceProcessor) -> None:
    ...
    result = source_processor.process_source(
      "com.example", "library", "1.0.0", "git@github.com:user/repo", git_ref="v1.0.0"
    )
  ...
  def test_process_git_source_missing_ref(
    self, source_processor: SourceProcessor
  ) -> None:
    """Test processing Git source without git_ref raises ValueError."""
    with pytest.raises(ValueError, match="git_ref is required"):
      source_processor.process_source(
        "com.example", "library", "1.0.0", "https://github.com/user/repo.git"
      )

  def test_parse_ssh_git_uri_invalid_format(
    self, source_processor: SourceProcessor
  ) -> None:
  ...
  def test_process_git_ssh_source_missing_ref(
    self, source_processor: SourceProcessor
  ) -> None:
    """Test processing SSH Git source without git_ref raises ValueError."""
    with pytest.raises(ValueError, match="git_ref is required"):
      source_processor.process_source(
        "com.example", "library", "1.0.0", "git@github.com:user/repo"
      )

  def test_cleanup_failed_processing_jar(
    self, source_processor: SourceProcessor, temp_dir: Path
  ) -> None:
    ...
    source_processor.cleanup_failed_processing("com.example", "library", "1.0.0", "jar")

    assert not target_dir.exists()

  def test_cleanup_failed_processing_directory(
    self, source_processor: SourceProcessor, temp_dir: Path
  ) -> None:
  ...
  def test_cleanup_failed_processing_symlink(
    self, source_processor: SourceProcessor, sample_directory: Path
  ) -> None:
    ...
    source_processor.cleanup_failed_processing("com.example", "library", "1.0.0", "git")
